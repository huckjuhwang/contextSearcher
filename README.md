...
각 동작방식에 대해서 시간을 분석 하고, 가장 시간이 많이 소요되는 부분에서 속도를 하나하나 개선해 나감.<br><hr>

1.1 멀티쓰레드 사용<br><hr>
![image](https://user-images.githubusercontent.com/47339929/112757312-3d80b680-9024-11eb-80bd-45afc7743825.png)

문화요소를 추출하는 과정에서 한개의 요소당 0.01초가 소요되었고, 만약 추출해야되는 문화요소 개수가 2000개라고 한다면 추출하는데에서 걸리는 시간만 20초이상의 시간을 잡아먹는 상황이였습니다 <br>
이 부분에서 멀티쓰레드를 사용하여 300단위 당 쓰레드1개를 생성하여 속도를 향상시켰습니다.
...
4. 표접을때 보여지는 텍스트를 "형태소"와 "추출 개수"가 보여지도록 수정하였습니다.
